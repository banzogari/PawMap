...
enum class CategoryType(
    ...
    SHOP(null, R.drawable.ic_store, R.drawable.ic_marker_shop, R.color.cat_default),
    MUSEUM(null, R.drawable.ic_store, R.drawable.ic_marker_default, R.color.cat_default),
